    ...
    function() {
        function t() {
            u = window.innerWidth, c = window.innerHeight, g = {
                x: u / 2,
                y: c / 2
            }, p = document.getElementsByClassName("large-header")[1], p.style.height = c + "px", f = document.getElementsByClassName("demo-canvas")[1], f.width = u, f.height = c, m = f.getContext("2d"), d = [];
