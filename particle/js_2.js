    ...
    function() {
        function t() {
            u = window.innerWidth, c = window.innerHeight, g = {
                x: u / 2,
                y: c / 2
            }, p = document.getElementsByClassName("large-header")[2], p.style.height = c + "px", f = document.getElementsByClassName("demo-canvas")[2], f.width = u, f.height = c, m = f.getContext("2d"), d = [];
